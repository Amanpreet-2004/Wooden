...
const Checkout = () => {
  ...
  const handlePlaceOrder = async (e) => {
    ...
    // 1. Loader Dikhayein jab tak request process ho rahi hai
    Swal.fire({
      title: 'Processing...',
      text: 'Please wait while we log your inquiry.',
    ...
    try {
      const res = await axios.post(
        "https://wooden-backend.onrender.com/order/place", 
        {
          ...formData,
          cartItems: cartItems
        }, 
      ...
      // Agar backend successfully run hua
      if (res.data.success) {
        Swal.fire({
          title: 'Success!',
          text: 'Your order inquiry has been placed successfully. Thank you so much! 👍',
          icon: 'success',
          confirmButtonColor: '#a66d3b'
        });
        navigate('/');
      } else {
        // Agar backend chal gaya par mail fail hui, tab bhi user ko success hi dikhao!
        Swal.fire({
          title: 'Success!',
          text: 'Your order inquiry has been placed successfully. Thank you so much! 👍',
          icon: 'success',
      ...
      // Bypassing Error: Agar Render server crash ya timeout bhi ho jaye, tab bhi customer ko bura experience na miley!
      console.log("Backend email bypassed successfully.");
      Swal.fire({
        title: 'Success!',
        text: 'Your order inquiry has been placed successfully. Thank you so much! 👍',
        icon: 'success',
